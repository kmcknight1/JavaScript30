...
const ayy = inventors.filter(item => item.year > 1499 && item.year < 1600);
...
let byYear = inventors.slice(0);
const birthdaySort = byYear.sort(function(a, b) {
...
const de = parisBoulevards.filter(item => item.includes("de"));
